    ...
    <footer className="bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">IntelliSearch</h3>
            <p className="text-sm">
              A powerful search engine with AI capabilities.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/news" className="hover:text-primary-600 dark:hover:text-primary-400">
                  News
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/faq" className="hover:text-primary-600 dark:hover:text-primary-400">
                  FAQ
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} IntelliSearch. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
